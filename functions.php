...
*/
 function lander_scripts() {
 	if (is_front_page()) {
 		...
 		wp_enqueue_script('portfolio-script', get_stylesheet_directory_uri() . '/portfolio.js', array('jQuery'));
 	}
 	if (is_archive()) {
 		wp_enqueue_style('archive-styles', get_stylesheet_directory_uri() . '/archive.css', array('jQuery'));
 	}
 }
